...
for i in range(len(lst)):
    if 'hlt' in lst[i]:
        for j in range(i+1,len(lst)):  #to be rectified
            lst.pop()
        break
...
label_length=len(var_list)             
vardict={}

for i in range((len(lst))):
    if 'var' in lst[i]:
        vardict[lst[i][-1]]=d2b(len(lst)-len(var_list))
        var_list.pop()
...
for i in range(len(lst)):
        if ":" in lst[i][0]:
            ...
            for j in range(i):
                if new in lst[j]:
                    labelstore[new]=d2b(j-label_length-1)
                else:    
                    labelstore[new]=d2b(i+1-label_length-1)
...
#     def errorgen_typo(lst,error_list):
                ...
                # 'jmp':'11111','jlt': "01100", 'jgt':"01101",'je':'01111','hlt': '01010','var':''}
...
#     #     for i in range(len(lst)):
#     #         if lst[i][0] in opcodeD or opcodeE and lst[i][-1] not in labelstore:
#     #             if 'label' in lst[i][-1]:
...
# def error(error_list,lst):
#     dict={"R0":"000","R1":"001","R2":"010","R3":"011","R4":"100","R5":"101",
#             "R6":"110","FLAGS":"111",'add':"10000",'sub': '10001','mul': '10110',
#             'xor':'11010' ,'or':'11011','and': '11100','mov': '10010','ls':'11001','rs': '11000',
#             'mov':'10011','div':'10111','not':'11101','cmp':'11110','ld':'10100','st':'10101',
#             'jmp':'11111','jlt': "01100", 'jgt':"01101",'je':'01111','hlt': '01010','var':''}
#     def typo_error(error_list,lst):
#         words=[]
#         for i in lst:
#             for j in i:
#                 if j in dict:
#                     words.append(j)
#         print(words)     
#     typo_error(error_list,lst)
# error(error_list,lst)                   
...
def main():
    ...
    for i in range(len(lst)): 
        for j in lst[i]:  
            ...
            elif j in opcodeB and lst[i][2] not in Reg_Binary:
                TypeB(opcodeB,lst[i],Reg_Binary)

            elif j in opcodeC and lst[i][2] in Reg_Binary:
